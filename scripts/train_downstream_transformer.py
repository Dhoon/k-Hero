...
사용법::
    ...
    # config 지정
    python scripts/train_downstream.py --config configs/downstream_transformer/default.yaml --fold all_type --mode t1
"""
...
from src.adt.engine.train_downstream_transformer import ALL_FOLDS, train_fold, train_all_folds
